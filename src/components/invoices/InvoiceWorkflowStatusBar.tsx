...
const STATUS_STEP_INDEX: Record<InvoiceWorkflowStatus, number> = {
  DRAFT: 0,
  SENT: 1,
  PARTIALLY_PAID: 2,
  PAID: 3,
...
function stepIndex(status: InvoiceWorkflowStatus): number {
...
export default function InvoiceWorkflowStatusBar({
  status,
  className = "",
}: {
  status: InvoiceWorkflowStatus;
