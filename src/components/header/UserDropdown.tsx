...
export default function UserDropdown() {
  ...
  useEffect(() => {
    refreshFromSession();
    window.addEventListener(AUTH_USER_CHANGED_EVENT, refreshFromSession);
    return () =>
      window.removeEventListener(AUTH_USER_CHANGED_EVENT, refreshFromSession);
  }, [refreshFromSession]);
  ...
  const shortName =
    ...
    sessionUser?.fullName?.split(/\s+/)[0] ||
    "User";
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="mr-1 block max-w-[140px] truncate text-theme-sm font-medium">
          {shortName}
        </span>
        ...
        <ul className="flex flex-col gap-1 border-b border-gray-200 pb-3 pt-4 dark:border-gray-800">
          ...
          <li>
            ...
            >
              ...
              >
                <path
                  d="M7 11V8a5 5 0 0 1 10 0v3M6 11h12v9a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1v-9Z"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
